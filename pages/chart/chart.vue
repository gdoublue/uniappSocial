<template>
	<view>
		<!-- 聊天消息视图 -->
			...
			<view id='tobb' class="mt-1 text-center bg-white" :style="'height:'+ transHeight+ 'px;'" >
			</view>
			<uni-popup type="bottom" ref='popup'>
				<view class="mt-1 text-center bg-white" :style="'height:'+ transHeight+ 'px;'" ></view>
			</uni-popup>
		</scroll-view>
		...
		<!-- 底部操作条 -->
		<view style="height: 100rpx; left: 0; right: 0; position: fixed;" :style="'bottom:'+ inputBottom + 'px;'" class=" flex align-center border-top bg-white">

			<input type="text" v-model="inputText" class="flex-1 rounded bg-light ml-2  " @focus="pageToBottom" style="padding: 10rpx; "
				...
				list:
				 [
					...
					avatar: "/static/demo/userpic/6.jpg",
						...
						avatar: "/static/default.jpg",
						username: "昵称",
						data: "/static/female.jpg",
						type: "img",
						create_time: 1590783530
					},
				]
			}
		},
