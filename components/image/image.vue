<template>
	<view>
		<view class="uni-common-mt" v-show="show">
								...
								<view class="uni-uploader__files">
									<block v-for="(image,index) in imageList" :key="index">
										<view class="uni-uploader__file position-relative">
											...
											<text class="position-absolute top-0 right-0 iconfont icon-shanchu text-white px-1 rounded"
											style="background-color: rgba(0,0,0,0.5);" @click="deleteImage(index)"></text>
										</view>
									</block>
	...
	export default {
		...
		watch: {
			imageList:function(newValue, oldValue) {
				this.$emit("imagesChange",newValue)
			}
		}
	}
</script>
